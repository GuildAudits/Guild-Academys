...
const TextType = ({
  ...
  // Cursor blink without external libs
  useEffect(() => {
  ...
  return createElement(
    ...
    <span className="inline" style={color ? { color } : undefined}>
      {displayedText}
    </span>,
    showCursor && (
      <span
        ref={cursorRef}
        className={`ml-1 inline-block ${shouldHideCursor ? 'opacity-0' : ''} ${cursorClassName}`}
